...
import ImovelSearchSelect from '@/shared/components/references/ImovelSearchSelect'
import { getImovelLabel } from '@/shared/components/references/reference-formatters'
...
import { canEdit } from '@/shared/services/auth.service'
import { normalizePaginated } from '@/shared/services/api'
import { buscarImovelReferencia } from '@/shared/services/escritorio-referencias.service'
import { dadosSaidaApi, pesagensApi } from '@/shared/services/silo.service'
import type {
  AuthUser,
  DadosSaidaPesagem,
  ImovelReferencia,
